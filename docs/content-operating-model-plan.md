...
### Шаг 1. Создать инфо-модель

Пользователь:

- создает модель с нуля
- или копирует существующую
- или создает из базового шаблона
- или собирает draft по источникам

### Шаг 2. Назначить модель категории
...
### Шаг 3. Привязать категории каналов
...
### Шаг 4. Создать экспортный профиль
...
3. Добавить новый placeholder / thin page для `Экспортные профили`
...
3. draft from marketplace + competitor fields
4. reusable attribute library
